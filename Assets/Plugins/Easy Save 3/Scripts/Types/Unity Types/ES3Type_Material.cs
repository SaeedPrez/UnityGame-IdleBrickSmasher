            ...
            foreach (string propertyName in reader.Properties)
                switch (propertyName)
                {
                    ...
                    default:
                        ...
                        {
                            instance.SetTextureScale(propertyName.Split(new[] { "_TextureScale" }, StringSplitOptions.None)[0], reader.Read<Vector2>());
                        }
                        else if (propertyName.EndsWith("_TextureOffset"))
                        {
                            instance.SetTextureOffset(propertyName.Split(new[] { "_TextureOffset" }, StringSplitOptions.None)[0], reader.Read<Vector2>());
                        }
