...
namespace DG.Tweening
{
    ...
    public static class ShortcutExtensionsTMPText
    {
        ...
        /// </param>
        public static TweenerCore<string, string, StringOptions> DOText(this TMP_Text target, string endValue, float duration, bool richTextEnabled = true,
    ...
    public class DOTweenTMPAnimator : IDisposable
    {
        ...
        ///     If you want to animate the whole text object you don't need this, and you can use direct <see cref="TMP_Text" /> DO shortcuts instead.
        ///     <para />
