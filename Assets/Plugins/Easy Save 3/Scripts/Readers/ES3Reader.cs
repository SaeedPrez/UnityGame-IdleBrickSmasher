...
public abstract class ES3Reader : IDisposable
{
    ...
    /// <returns>
    ///     The objectContainingProperty object. This is helpful if you're setting a private property on a struct or other immutable type and need to return the boxed
    ///     value.
    /// </returns>
    ...
    internal Type ReadTypeFromHeader<T>()
    {
        ...
        if (typeof(T) == typeof(object)) return ReadKeyPrefix();
