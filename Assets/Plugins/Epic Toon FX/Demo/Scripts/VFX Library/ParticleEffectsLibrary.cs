...
#pragma warning disable 414
        ...
        public void SpawnParticleEffect(Vector3 positionInWorldToSpawn)
        {
            ...
            if (ParticleEffectLifetimes[CurrentParticleEffectIndex] == 0) currentActivePEList.Add(newParticleEffect.transform);
            currentActivePEList.Add(newParticleEffect.transform);
            // Destroy Particle Effect After Lifetime expired
            if (ParticleEffectLifetimes[CurrentParticleEffectIndex] != 0) Destroy(newParticleEffect, ParticleEffectLifetimes[CurrentParticleEffectIndex]);
        }
    }
}