...
public class ES3Cloud : ES3WebClass
{
    ...
    /// <summary>
    ///     A UTC DateTime object representing the date and time a file on the server was last updated. This should only be called after calling the 'DownloadTimestamp'
    ///     routine.
    /// </summary>
    ...
    /// <summary>
    ///     Synchronises the default file with a file on the server. If the file on the server is newer than the local copy, the local file will be overwritten by the file
    ///     on the server. Otherwise, the file on the server will be overwritten.
    /// </summary>
    ...
    /// <summary>
    ///     Synchronises a local file with a file on the server. If the file on the server is newer than the local copy, the local file will be overwritten by the file on
    ///     the server. Otherwise, the file on the server will be overwritten.
    /// </summary>
    ...
    ///     A search pattern containing '%' or '_' wildcards where '%' represents zero, one, or multiple characters, and '_' represents a single
    ///     character.
    /// </param>
    ...
    /// <summary>
    ///     Downloads the timestamp representing when the server file was last updated. The downloaded timestamp is stored in the 'timestamp' variable of the ES3Cloud
    ///     object.
    /// </summary>
